    ...
    extend: {
      colors: {
        ...
        nike: {
          ...
          green: "#00A36C",
          blue: "#0063D1",
          volt: "#CCFF00", // Nike's signature neon green/yellow
        },
      ...
      boxShadow: {
        ...
        'neon': '0 0 15px rgba(204, 255, 0, 0.7)',
        'colored': '0 10px 20px -5px rgba(59, 130, 246, 0.3)',
      },
      backgroundImage: {
        'gradient-radial': 'radial-gradient(var(--tw-gradient-stops))',
        'gradient-conic': 'conic-gradient(from 180deg at 50% 50%, var(--tw-gradient-stops))',
        'gradient-diagonal': 'linear-gradient(to right bottom, var(--tw-gradient-stops))',
        'nike-pattern': "url('/patterns/nike-pattern.svg')",
      },
    },
  },
